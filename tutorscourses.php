...
<body>
	...
	if (mysqli_num_rows($result) > 0) {
              ...
              echo "<table><tr><th>Course</th><th>Description</th>";
    ...
    echo "<tr><td>$name<br><img src='uploadedfiles/$pic' height='100' width='100'</td><td>$detailsdata</td><td><a href='editmycourse.php?id1=$id'>"
            . "<img src='uploadedfiles/editimg.jpeg' style='width:42px;height:42px;border:0;'></a></td></tr>";
